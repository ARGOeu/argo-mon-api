...
public class ProjectService {
    ...
    @Transactional
    public PageResource<ProjectResponseDto> getAllProjectsByPageAndSize(int page, int size, UriInfo uriInfo) {

        var projects = projectRepository.fetchProjectByPage(page, size);
